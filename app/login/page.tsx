...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-subtle)" }}>
      ...
      <div className="hero-gradient-vibrant h-[320px] sm:h-[360px]" />

      <div className="relative z-10 mx-auto -mt-[200px] max-w-lg px-4 pb-16 sm:px-6">
        {/* Logo */}
        ...
        <div className="animate-fade-in-scale" style={{ animationDelay: "0.1s" }}>
          ...
          <form action={signInWithGitHub} className="mt-10">
            <button
              type="submit"
              className="btn-primary group flex w-full items-center justify-center gap-3 px-6 py-4 text-base"
            >
